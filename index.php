          ...
          <div class="range section-100-vh range-xs-middle range-xs-center range-md-right">
            <div class="col-md-6 col-sm-9 postfix-md-right-90 postfix-xl-right-0" data-caption-animate="fadeInDown"
              ...
              <div class="group"><a class="btn btn-white btn-form" href="servicios">Nuestros servicios</a><a
                  class="btn btn-default btn-form" href="contactanos" data-toggle="modal" data-target="#modalContact">Contáctanos</a></div>
            </div>
          </div>
        </div>
      </div>
...
<section
  ...
  <div class="shell">
    ...
    <div class="range">
      <div class="col-sm-12 col-lg-3 mr-lg-5 ml-lg-5"><span
...
<section class="section-75 section-md-120 section-xl-130 bg-darker">
  <div class="shell">
    <div class="range">
      ...
      <div class="col-md-4 col-md-middle text-center"><a class="btn btn-default btn-default-white"
          href="contact-us.php" data-toggle="modal" data-target="#modalContact">Contacto</a></div>
    </div>
  </div>
</section>
