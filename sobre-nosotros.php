...
<!-- About-->
<section class="section section-75 section-md-120 section-lg-120 section-xl-160" id="about">
        ...
        <div class="range">
            <div class="cell-sm-6 section-sm-40 section-lg-80 section-lg-bottom-110">
                <div class="divider-block">
                    ...
                    <h6>Es una empresa especialista en metal mecánica, servicios industriales y de construcción en
                        general.
                    </h6>
                    <p>De raíz orgullosamente salvadoreña ha venido desarrollándose paralelamente con el avance complejo
                        que
                        ha tenido la industria en El Salvador y el mundo. Dicho desarrollo ha generado eventualmente la
                        adquisición de amplitud de experiencia, misma que ha permitido incursionar en distintas áreas de
                        trabajo
                        con lo cual es posible dar soluciones integrales a la industria con la garantía que el cliente
                        siempre
        ...
        <div class="row spacing-55">
            <div class="col-sm-6 my-auto">
                    ...
                    <p>Cuenta con las prestaciones de Ley (ISSS, AFP, aguinaldos, vacaciones) uniformes con el
                        ...
                        (Lentes, guantes, zapatos con cubo, protección auditiva) proporcionados por TEM-MORAN.
                        Contamos con personal profesional multidisciplinario formado en universidades como:
                    </p>
                    <ul>
            ...
            <div class="col-sm-6">
                    ...
                    <p>Nuestro personal cuenta con capacitaciones para realizar trabajos de alto riesgo en altura,
                        ...
                        empresas certificadas además de pruebas poligráficas vigentes.
                    </p>
            ...
            <div class="col-sm-6">
                    ...
                    <p>Nuestros equipos eléctricos (aparatos para soldar, pulidoras, taladros, extensiones, ect.)
                        ...
                        Nuestros equipos para levantamiento de carga (tecles, eslingas de ceda, grilletes, etc.) cumplen
                        con las normas internaciones de seguridad ANSI-OSHA.
                        Nuestros equipos para corte oxiacetilénico y plasma también cumplen con las normas
